  ...
  <header class="bg-gray-100 shadow-md">
    <nav class="flex items-center justify-between py-4 px-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <a href="/tests-list" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-200">Список тестов</a>
        <a href="/create-test" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-200">Создать тест</a>
      ...
      <div class="flex items-center space-x-4">
        ...
        <a class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-200">Выйти</a>
      </div>
    </nav>
  </header>
</template>
...
export default {
  name: 'Header',
  // You can add your Vue.js logic here if needed
};
</script>
